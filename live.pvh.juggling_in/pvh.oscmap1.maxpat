...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 187.0, 541.5, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 82.407185673713684, 20.0, 37.892910599708557, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 608.0, 29.5, 22.0 ],
					"text" : "id 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.0, 596.5, 71.5, 22.0 ],
					"text" : "scale 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.44606614112854, 345.726620197296143, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 510.287792682647705, 316.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.0, 316.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 550.0, 238.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 245.823217511177063, 20.0, 25.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 692.5, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 550.0, 644.5, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 215.0, 234.0, 63.0, 22.0 ],
					"text" : "unpack s f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 114.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 145.0, 46.0, 22.0 ],
					"text" : "port $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 175.5, 67.0, 22.0 ],
					"text" : "udpreceive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 342.0, 68.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 105.5, 79.0, 22.0 ],
					"text" : "set \"#1\""
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.423529411764706, 0.890196078431372, 0.67843137254902, 0.0 ],
					"fontface" : 1,
					"id" : "obj-24",
					"maxclass" : "live.comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 131.0, 153.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 57.0, 18.0 ],
					"text" : "oscinput1",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 61.0, 93.0, 61.0, 22.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 1,
					"parameter_enable" : 1,
					"patching_rect" : [ 61.0, 70.0, 151.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 0.0, 38.407185673713684, 19.0 ],
					"rounded" : 0.0,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.5, 216.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 251.847169756889343, 0.0, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.5, 247.0, 73.0, 22.0 ],
					"text" : "speedlim 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.5, 271.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 47.5, 319.0, 151.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 86.0, 0.0, 184.823217511177063, 19.0 ],
					"rounded" : 0.0,
					"text" : "/club1/val 0.921038"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 381.5, 32.0, 22.0 ],
					"text" : "127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 381.5, 29.5, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 323.0, 351.5, 44.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 260.0, 448.5, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 323.0, 331.5, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.300096273422241, 20.0, 37.523121237754822, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_initial" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 291.0, 624.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 336.0, 541.5, 39.0, 22.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 591.5, 71.5, 22.0 ],
					"text" : "scale 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 260.0, 532.5, 29.5, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 336.0, 517.5, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 201.823217511177063, 20.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "0", "99999999" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 291.5, 479.5, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 157.823217511177063, 20.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "0", "99999999" ],
							"parameter_initial" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 260.0, 315.5, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 20.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 176.0, 104.0, 188.0, 96.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 48.0, 192.0, 52.0, 20.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 48.0, 215.0, 67.0, 20.0 ],
									"text" : "substitute 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 144.0, 280.0, 22.0, 20.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 144.0, 256.0, 32.5, 20.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 32.0, 88.0, 67.0, 20.0 ],
									"text" : "select 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 56.0, 112.0, 32.5, 20.0 ],
									"text" : "path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 32.0, 167.0, 51.0, 20.0 ],
									"text" : "live.path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.0, 136.0, 104.0, 31.0 ],
...
,
					"patching_rect" : [ 365.0, 644.5, 75.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 421.0, 622.5, 40.0, 16.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 370.0, 622.5, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 44.0, 20.0, 38.407185673713684, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 692.5, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"smoothing" : 1.0
					}
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 301.0, 506.0, 591.0, 506.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 345.5, 577.0, 601.5, 577.0 ],
					"order" : 0,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 4 ],
					"midpoints" : [ 345.5, 576.0, 311.5, 576.0 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 332.5, 434.5, 280.0, 434.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 364.5, 434.5, 280.0, 434.5 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 268.5, 300.0, 572.5, 300.0 ],
					"order" : 0,
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 559.5, 301.0, 559.5, 301.0 ],
					"order" : 0,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 559.5, 266.0, 519.787792682647705, 266.0 ],
					"order" : 1,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 519.94606614112854, 629.0, 559.5, 629.0 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 1 ],
					"midpoints" : [ 374.5, 677.5, 324.5, 677.5 ],
					"source" : [ "obj-6", 0 ]
				}
