...
, 			{
				"box" : 				{
					...
					"region_bounds" : [ 1750.393676757812727, 3649.6063232421875 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 940.0, 480.0, 61.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.166664570569992, 44.0, 61.0, 18.0 ],
					"text" : "position"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 996.0, 480.0, 45.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.166664570569992, 47.5, 45.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.166664570569992, 63.0, 61.0, 18.0 ],
					"text" : "positionVar"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 59.166664570569992, 65.0, 45.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 0 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 316.000002026557922, 0.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.166664570569992, -1.5, 226.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 268.833335429430008, 127.5, 36.0, 18.0 ],
					"text" : "in"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 289.666668623685837, 129.5, 66.5, 12.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 45.0, 142.0, 22.0 ],
					"text" : "s #1-record"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 29.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
