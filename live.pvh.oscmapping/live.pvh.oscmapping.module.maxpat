...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "live.pvh.oscmapping.view.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 452.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "signal" ],
					"patching_rect" : [ 60.0, 120.0, 187.0, 22.0 ],
					"text" : "live.pvh.oscmapping.model #1 #2",
...
, 			{
		...
		"parameters" : 		{
			"obj-2::obj-36" : [ "live.text[1]", "live.text", 0 ],
			"parameterbanks" : 			{
...
,
		"dependency_cache" : [ 			{
				"name" : "live.pvh.oscmapping.model.maxpat",
				"bootpath" : "~/src/PVH-maxforlivelib/live.pvh.oscmapping",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../PVH-maxlib_ossia/signal/ossia.pvh.scale~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
