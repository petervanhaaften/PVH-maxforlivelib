...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 140.0, 149.09021000000007, 47.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 47.09021000000007, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 140.0, 125.09021000000007, 47.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 25.09021000000007, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "0", "1" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 140.0, 103.0, 47.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 3.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "0", "1" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 196.0, 115.0, 22.0 ],
					"text" : "s #1-barlength"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 151.0, 135.0, 22.0 ],
					"text" : "s #1-remote offset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 104.0, 140.0, 22.0 ],
					"text" : "s #1-triggersperbar"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 195.0, 80.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -9.0, 45.59021000000007, 56.0, 18.0 ],
					"text" : "trigs/bar",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 150.0, 86.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -13.0, 23.59021000000007, 60.0, 18.0 ],
					"text" : "offset",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 110.0, 47.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -13.0, 1.5, 60.0, 18.0 ],
					"text" : "triggers",
					"textjustification" : 2
				}
