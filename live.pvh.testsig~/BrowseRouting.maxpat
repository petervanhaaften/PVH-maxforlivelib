...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 310.0, 210.0, 52.0, 22.0 ],
					"text" : "route int"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 30.0, 130.0, 70.0, 49.0 ],
									"text" : "substitute control_fg textcolor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 70.0, 63.0, 22.0 ],
									"text" : "control_fg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 30.0, 100.0, 64.0, 22.0 ],
									"text" : "live.colors"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 70.0, 210.0, 49.0, 20.0 ],
									"text" : "Umenu"
								}
...
,
					"patching_rect" : [ 30.0, 330.0, 49.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 190.0, 70.0, 32.0, 22.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 230.0, 70.0, 83.0, 20.0 ],
									"text" : "Transparency"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 159.0, 18.0, 81.0, 20.0 ],
									"text" : "Device on/off"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 240.0, 50.5, 22.0 ],
									"text" : "join 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "int", "int" ],
									"patching_rect" : [ 150.0, 40.0, 99.0, 22.0 ],
									"text" : "live.thisdevice"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 61.5, 210.0, 31.5, 22.0 ],
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 30.0, 130.0, 139.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 150.0, 240.0, 92.0, 49.0 ],
									"text" : "substitute contrast_frame bordercolor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 40.0, 100.0, 35.0 ],
									"text" : "control_text_bg, contrast_frame"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 30.0, 90.0, 64.0, 22.0 ],
									"text" : "live.colors"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 70.0, 350.0, 41.0, 20.0 ],
									"text" : "Panel"
								}
...
,
					"patching_rect" : [ 530.0, 370.0, 49.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 90.0, 167.0, 43.0, 22.0 ],
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 240.0, 37.0, 22.0 ],
					"text" : "Input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 140.0, 95.0, 22.0 ],
					"text" : "loadmess #1 #2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 330.0, 64.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 290.0, 139.0, 22.0 ],
					"text" : "sprintf set %s %d/%d"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 250.0, 240.0, 29.5, 22.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 310.0, 240.0, 29.5, 22.0 ],
					"text" : "* 2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 14.0, 75.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 29.0, 75.0, 20.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 31.0, 75.0, 14.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 16.0, 75.0, 14.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Max for Live Devices/Audio Routing Example Project/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
