...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 106.0, 613.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 19.0, 96.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.0, 651.0, 124.0, 22.0 ],
					"text" : "s #1-paramout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.0, 487.0, 156.0, 22.0 ],
					"text" : "s #1-maponcebutton"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.0, 431.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.0, 378.0, 166.0, 22.0 ],
					"text" : "r #1-mapbutton_return"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 456.0, 530.0, 130.0, 22.0 ],
					"text" : "s #1-mapbutton"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 512.0, 463.0, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.769911646842957, 19.0, 40.0, 16.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 456.0, 463.0, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 19.0, 40.0, 16.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 34.0, 79.769911646842957, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 512.5, 152.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 1.0, 56.5, 18.0 ],
					"text" : "oscinput1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 412.0, 243.5, 45.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 34.0, 45.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "0", "10000" ],
							"parameter_longname" : "live.numbox[5]",
							"parameter_mmax" : 9999999999999.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 412.0, 200.5, 45.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 34.0, 45.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					"color" : [ 1.0, 0.623529411764706, 0.294117647058824, 1.0 ],
					"id" : "obj-21",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 240.0, 149.0, 22.0 ],
					"text" : "send #1-rampdown"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.5, 200.5, 134.0, 22.0 ],
					"text" : "send #1-rampup"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 245.0, 0.0, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 266.0, 1.115044176578522, 16.769911646842957, 16.769911646842957 ],
					"thickness" : 100.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 265.0, 109.0, 22.0 ],
					"text" : "send #1-sig"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 0.0, 163.0, 19.0 ],
					"text" : "\"/value/ 0.32\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 450.0, 114.0, 22.0 ],
					"text" : "send #1-port"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 58.0, 0.0, 42.0, 19.0 ],
					"text" : "9001"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 56.5, 19.0 ],
					"proportion" : 0.39
				}
