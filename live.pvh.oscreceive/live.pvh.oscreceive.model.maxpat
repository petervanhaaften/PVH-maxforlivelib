...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 603.0, 496.0, 73.0, 22.0 ],
					"text" : "s mapglobal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.0, 472.0, 84.0, 22.0 ],
					"text" : "s paramglobal"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 426.0, 406.0, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 484.0, 361.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 523.0, 262.5, 122.0, 22.0 ],
					"text" : "r #1-paramout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 594.5, 448.0, 50.0, 22.0 ],
					"text" : "id 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 638.0, 406.0, 168.0, 22.0 ],
					"text" : "s #1-mapbutton_return"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.0, 338.0, 154.0, 22.0 ],
					"text" : "r #1-maponcebutton"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.0, 307.5, 128.0, 22.0 ],
					"text" : "r #1-mapbutton"
				}
...
,
					"patching_rect" : [ 582.0, 375.0, 75.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 227.0, 637.0, 270.0, 22.0 ],
					"text" : "ossia.parameter rampdown @type int @default 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 195.5, 610.0, 254.0, 22.0 ],
					"text" : "ossia.parameter rampup @type int @default 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 164.0, 667.0, 82.0, 22.0 ],
					"text" : "rampsmooth~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 431.0, 106.5, 127.0, 22.0 ],
					"text" : "ossia.model #1"
				}
