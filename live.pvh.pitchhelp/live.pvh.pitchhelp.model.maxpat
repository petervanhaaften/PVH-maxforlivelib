...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 91.0, 228.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 206.0, 266.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.75, 330.0, 117.0, 22.0 ],
					"text" : "s #1-finalout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 227.0, 181.0, 29.5, 22.0 ],
					"text" : "*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 264.75, 143.5, 133.0, 22.0 ],
					"text" : "r #1-octavesize"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 301.0, 265.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 330.0, 116.0, 22.0 ],
					"text" : "r #1-notems"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.25, 191.5, 122.0, 22.0 ],
					"text" : "r #1-pitchaug"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.75, 96.0, 150.0, 20.0 ],
					"text" : "pitch number"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 96.0, 150.0, 20.0 ],
					"text" : "octave number"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 200.0, 118.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "pitch number int",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 91.0, 118.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 354.0, 68.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 780.0, 31.0, 68.0, 20.0 ],
					"text" : "note length"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 374.0, 91.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 405.0, 49.0, 22.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.25, 215.5, 59.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 781.347594999999956, 81.0, 57.0, 20.0 ],
					"text" : "pitch aug"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 135.0, 249.0, 29.5, 22.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 273.0, 55.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 781.597594999999956, 120.0, 53.75, 20.0 ],
					"text" : "final out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 135.0, 197.0, 29.5, 22.0 ],
					"text" : "+"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 144.5, 315.0, 24.25, 315.0 ],
					"order" : 2,
					"source" : [ "obj-13", 0 ]
				}
