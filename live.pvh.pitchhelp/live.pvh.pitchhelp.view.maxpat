...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.75, 67.0, 83.0, 22.0 ],
					"text" : "loadmess 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 9.0, 77.0, 22.0 ],
					"text" : "loadmess 48"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 87.5, 118.0, 22.0 ],
					"text" : "s #1-notems"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 36.0, 124.0, 22.0 ],
					"text" : "s #1-pitchaug"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 41.0, 145.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 44.75, 40.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.298797499999864, 73.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 44.75, 91.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.298797499999864, 26.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 91.0, 68.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.173797499999978, 9.0, 68.0, 20.0 ],
					"text" : "note length"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 40.0, 59.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.347594999999956, 56.0, 57.0, 20.0 ],
					"text" : "pitch aug"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 145.0, 55.0, 20.0 ],
					"presentation" : 1,
