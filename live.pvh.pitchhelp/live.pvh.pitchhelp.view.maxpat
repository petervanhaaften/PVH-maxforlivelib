...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 205.0, 409.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.201202500000136, 151.612794458866119, 61.736264407634735, 17.994505226612091 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "const", "clip" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 367.5, 50.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.7324690461827, 137.54896467924118, 64.798797499999864, 18.0 ],
					"text" : "output mode",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 379.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 444.0, 125.0, 22.0 ],
					"text" : "s #1-outmode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.75, 251.5, 122.0, 22.0 ],
					"text" : "r #1-finalout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.75, 187.0, 83.0, 22.0 ],
					"text" : "loadmess 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 129.0, 77.0, 22.0 ],
					"text" : "loadmess 48"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 207.5, 125.0, 22.0 ],
					"text" : "s #1-notems"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 156.0, 131.0, 22.0 ],
					"text" : "s #1-pitchaug"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 44.75, 290.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.201202500000136, 98.351648271083832, 61.736264407634735, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 44.75, 160.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.201202500000136, 66.404762029647827, 61.736264407634735, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 44.75, 211.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.201202500000136, 33.434579432010651, 61.736264407634735, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 211.0, 58.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.666929703817232, 18.577436923980713, 58.0, 18.0 ],
					"text" : "note length",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 160.0, 52.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.666929703817232, 51.434579432010651, 57.736264407634735, 18.0 ],
					"text" : "pitch aug",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.75, 290.0, 50.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.666929703817232, 84.357143044471741, 57.736264407634735, 18.0 ],
					"text" : "midi out",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"border" : 3,
					"bordercolor" : [ 0.847058823529412, 0.0, 0.819607843137255, 1.0 ],
					"id" : "obj-12",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 215.0, 128.0, 128.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
